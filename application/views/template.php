	...
	<body>
		...
		<div id="wrapper">
			...
			<nav class="navbar navbar-default navbar-fixed-top">
				<div class="brand">
					<a href="#" class="site-title"><i class="fa fa-book"></i><span>  PERPUSTAKAAN</span> </a>
				</div>
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="<?= base_url() ?>index.php/Kategori"><i class="fa fa-area-chart"></i> <span>Kategori Buku</span></a></li>
						<li><a href="<?= base_url() ?>index.php/Histori"><i class="lnr lnr-linearicons"></i> <span>Histori Peminjaman</span></a></li>
